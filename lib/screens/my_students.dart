...
class _MyStudentsScreenState extends State<MyStudentsScreen> {
  ...
  void _showStudentSheet(AttendanceStudent student) {
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${_selectedSection?.label ?? ''} · Roll ${student.rollNo}',
              style: const TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: [
                  _AttStat('Present', '18', AppColors.teal,
                      AppColors.tealLight),
                  const SizedBox(width: 10),
                  _AttStat('Absent', '2', AppColors.coral,
                      AppColors.coralLight),
                  const SizedBox(width: 10),
                  _AttStat('Late', '1', AppColors.amber,
            ...
            const SizedBox(height: 8),
            const Text(
              'Attendance data is approximate — based on current session.',
...
class _AttStat extends StatelessWidget {
  ...
  const _AttStat(this.label, this.value, this.color, this.bg);
