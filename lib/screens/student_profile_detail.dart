    ...
    return NestedScrollView(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          _AcademicsTab(tests: (profile['tests'] as List?)?.cast<Map<String, dynamic>>() ?? []),
          _ReportsTab(
            submissions: (profile['work_log_submissions'] as List?)
...
class _AcademicsTab extends StatelessWidget {
  ...
  const _AcademicsTab({required this.tests});
...
class _ReportsTab extends StatelessWidget {
  ...
  const _ReportsTab({required this.submissions});
...
class _SubmissionCard extends StatelessWidget {
  ...
  String _fmtType(String t) => switch (t) {
        'homework' => 'Homework',
        'note' => 'Note',
        _ => 'Classwork',
      };
